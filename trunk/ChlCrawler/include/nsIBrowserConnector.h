...
class NS_NO_VTABLE NS_SCRIPTABLE nsIBrowserConnector : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetWorkSpace(const nsACString & workspace) = 0;
...
#define NS_DECL_NSIBROWSERCONNECTOR \
  NS_SCRIPTABLE NS_IMETHOD SetWorkSpace(const nsACString & workspace); \
  NS_SCRIPTABLE NS_IMETHOD SetBrowser(nsIWebBrowser *browser); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIBROWSERCONNECTOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD SetWorkSpace(const nsACString & workspace) { return _to SetWorkSpace(workspace); } \
...
#define NS_FORWARD_SAFE_NSIBROWSERCONNECTOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD SetWorkSpace(const nsACString & workspace) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetWorkSpace(workspace); } \
...
/* void SetWorkSpace (in AUTF8String workspace); */
NS_IMETHODIMP nsBrowserConnector::SetWorkSpace(const nsACString & workspace)
{
